...
import { getAPIVersionFromNumber, isAPIFeatureEnabled, LWC_VERSION_COMMENT } from '@lwc/shared';
    ...
    return {
        Class(path, state) {
            ...
            if (node.superClass === null &&
                isAPIFeatureEnabled(4 /* APIFeature.SKIP_UNNECESSARY_REGISTER_DECORATORS */, getAPIVersionFromNumber(state.opts.apiVersion))) {
